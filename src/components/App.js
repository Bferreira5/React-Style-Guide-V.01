    ...
    <Switcher>
      ...
      <div path="/pattern"><PatternSubNav /></div>
        <div path="/pattern/atoms"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-raised"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-add"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-collapse"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-compound"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-flat"><PatternSubNav /></div>
          <div path="/pattern/atoms/button-icon"><PatternSubNav /></div>
          <div path="/pattern/atoms/checkboxes"><PatternSubNav /></div>     
          <div path="/pattern/atoms/radioselector"><PatternSubNav /></div>
    ...
    <Switcher>
      ...
      <div path="/pattern"><PatternContent /></div>
        <div path="/pattern/atoms"><PatternContent /></div>
          <div path="/pattern/atoms/button-raised"><PatternContent /></div>
          <div path="/pattern/atoms/button-add"><PatternContent /></div>
          <div path="/pattern/atoms/button-collapse"><PatternContent /></div>
          <div path="/pattern/atoms/button-compound"><PatternContent /></div>
          <div path="/pattern/atoms/button-flat"><PatternContent /></div>
          <div path="/pattern/atoms/button-icon"><PatternContent /></div>
          <div path="/pattern/atoms/checkboxes"><PatternContent /></div>     
          <div path="/pattern/atoms/radioselector"><PatternContent /></div>
