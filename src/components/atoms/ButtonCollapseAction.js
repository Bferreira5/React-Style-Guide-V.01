...
export class ButtonCollapseActionComponent extends Component {
  render() {
    return (
      <div className="guide-component-preview">
        <div className="guide-component-inner">
          <ButtonCollapseActionDescription />
          <p>code</p>
          <ButtonCollapseActionCode />
        </div>
        <div className="guide-component-inner">
          <p>Preview</p>
          <ButtonCollapseActionRaw />
        </div>
      </div>
    );
  }
...
export class ButtonCollapseActionDescription extends Component {
  render() {
    return (
