...
export class SlidersComponent extends Component {
  render() {
    return (
...
export class SlidersDescription extends Component {
  render() {
    return (
...
export class SlidersCode extends Component {
  render() {
	const Code = ReactDOMServer.renderToStaticMarkup(<SlidersRaw />);
  return (  	
...
export class SlidersRaw extends Component {
  render() {
    return (
